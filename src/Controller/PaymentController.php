...
class PaymentController extends AbstractController
{
    ...
    public function payment(OrderRepository $repository, $reference, EntityManagerInterface $em): Response
    {
        ...
        Stripe::setApiKey('sk_test_51MFEd6B0Q8xDu2xg3wqoqYwOzSEdB5Ugi7MWSVTr32YkjqHziiwBrMV5NwBtvTufEcLr3i5qDlDhox1dyQjWKIPs00zDxBxwkL');
        header('Content-Type: application/json');

        $YOUR_DOMAIN = 'https://ajdev.fr/';
